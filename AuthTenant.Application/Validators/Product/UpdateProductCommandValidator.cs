...
namespace AuthTenant.Application.Validators.Product
{
    ...
    public class UpdateProductCommandValidator : AbstractValidator<UpdateProductCommand>
    {
        ...
        /// <summary>
        /// Configura validações para ID do produto.
        /// </summary>
        private void ConfigureIdValidation()
        {
            RuleFor(x => x.Id)
                ...
                .Must(BeValidGuid)
                .WithMessage("ID do produto deve ser um GUID válido")
        ...
        private void ConfigurePriceValidation()
        {
            RuleFor(x => x.Price)
                ...
                .Must(NotHaveUnreasonablePriceChange)
                .WithMessage("Mudança de preço muito drástica. Verifique se está correto")
                .WithErrorCode("PRODUCT_PRICE_DRASTIC_CHANGE");
        }
        ...
        private void ConfigureStockValidation()
        {
            RuleFor(x => x.StockQuantity)
                ...
                .Must(NotHaveUnreasonableStockChange)
                .WithMessage("Mudança de estoque muito drástica. Verifique se está correto")
                .WithErrorCode("PRODUCT_STOCK_DRASTIC_CHANGE");
        }

        #region Custom Validation Methods

        /// <summary>
        /// Verifica se o ID é um GUID válido.
        /// </summary>
        ...
        /// <summary>
        /// Verifica se a mudança de preço não é muito drástica.
        /// Esta validação pode ser estendida para verificar contra o preço atual no banco.
        /// </summary>
        private static bool NotHaveUnreasonablePriceChange(decimal newPrice)
        {
            // Para atualização, pode ser útil verificar mudanças drásticas
            // Esta validação pode ser melhorada com acesso ao preço atual

            // Por enquanto, aceitar qualquer mudança dentro dos limites básicos
        ...
        {
            // Para atualizações, quantidade muito alta ainda pode ser suspeita
            return stockQuantity <= 100000; // Limite mais alto para atualizações
        }

        /// <summary>
        /// Verifica se a mudança de estoque não é muito drástica.
        /// Esta validação pode ser estendida para verificar contra o estoque atual.
        /// </summary>
        private static bool NotHaveUnreasonableStockChange(int newStockQuantity)
        {
            // Para atualização, pode ser útil verificar mudanças drásticas
            // Esta validação pode ser melhorada com acesso ao estoque atual

            // Por enquanto, aceitar qualquer mudança dentro dos limites básicos
            return newStockQuantity >= 0 && newStockQuantity <= MaxStockQuantity;
        }
